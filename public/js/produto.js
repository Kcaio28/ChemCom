...
async function carregarProduto() {
    try {
        ...
        document.querySelector("h1").innerHTML = `R$ ${Number(prod.preco).toFixed(2)}`;

        // Trocar imagens
        document.querySelectorAll("#thumb-gallery img")[0].src = `../uploads/imagens/${prod.imagem1}`;
        document.querySelectorAll("#thumb-gallery img")[1].src = `../uploads/imagens/${prod.imagem2}`;
        document.querySelectorAll("#thumb-gallery img")[2].src = `../uploads/imagens/${prod.imagem3}`;

        document.querySelectorAll(".carousel-item img")[0].src = `../uploads/imagens/${prod.imagem1}`;
        document.querySelectorAll(".carousel-item img")[1].src = `../uploads/imagens/${prod.imagem2}`;
        document.querySelectorAll(".carousel-item img")[2].src = `../uploads/imagens/${prod.imagem3}`;
    }
    catch (err) {
        console.error(err);
    }
